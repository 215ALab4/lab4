...
{\bf Where was the model performing poorly?}
  ...
  \begin{figure}[H]
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth, height = 170pts ]{classification_1.png}
\endminipage\hfill
\minipage{0.5\textwidth}
...
\end{figure}
  ...
  \begin{figure}[H]
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth, height = 170pts ]{classification_3.png}
\endminipage\hfill
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth, height = 170pts]{label_3.png}
\endminipage\hfill
\end{figure}

\begin{figure}[H]
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth, height = 170pts ]{classification_4.png}
\endminipage\hfill
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth, height = 170pts]{label_4.png}
\endminipage\hfill
\end{figure}
