...
\endminipage\hfill
\minipage{0.5\textwidth}
The AUC values for training on 2/3 of the images and testing on the remaining image is given to our left.  Since testing on image1 and image 2 performed well in comparison with testing on image 3, we include below the plots for misclassification only for image 1 and 3, and an example where the model performed better than the other.  
\endminipage\hfill
\end{figure}
...
\endminipage\hfill
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth, height = 170pts]{label_1.png}
\endminipage\hfill
\caption{prediction error for image 1-trained on image 2 and 3}
\end{figure}
...
\endminipage\hfill
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth, height = 170pts]{label_9.png}
\endminipage\hfill
\caption{prediction error for image 3-trainined on image 1 and 2}
\end{figure}
