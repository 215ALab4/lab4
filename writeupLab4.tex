...
\begin{figure}[h]
  \centering 
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[width=\linewidth]{qda1.prob.plot}
    \label{qda1}
  \end{subfigure} 
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[width=\linewidth]{qda2.prob.plot}
    \label{qda2}
  \end{subfigure}  
  \begin{subfigure}[b]{0.3\textwidth}
    \includegraphics[width=\linewidth]{qda3.prob.plot}
    \label{qda3}
  \end{subfigure}  
