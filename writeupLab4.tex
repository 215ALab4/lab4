...
The logit model obtained via averaging after 12-fold cross-validation has $\hat{y}_i = -3.356 + 1.900 * NDAI_i - 0.074 * SD_i + 9.002 * CORR_i.$

\begin{figure}[H]
\includegraphics[scale = .5]{threshold.png}
\caption{We see a minimum in misclassification rate at .38.}
\end{figure}

\begin{figure}[H]
\includegraphics[width = 18cm, height = 10cm]{LogitClassification.png}
\caption{Binary classifications with threshold = .38 for logit trained via 12-fold CV.}
\end{figure}

\begin{figure}[H]
\includegraphics[width = 18cm, height = 10cm]{LogitProbabilities.png}
